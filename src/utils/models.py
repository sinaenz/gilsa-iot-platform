...
class Splash(models.Model):
    ...
    latest_version = models.IntegerField(_('latest version number'), blank=True, default=0)
    ...
    minimum_version = models.IntegerField(_('minimum version number'), blank=True, default=0)
